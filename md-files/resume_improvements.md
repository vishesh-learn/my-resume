...
that represent the strongest expertise.
...
The projects section has strong technical detail, but each project
should clearly explain what the candidate personally built.
...
The resume can currently read as:
...
11. [ ] Add selected GitHub repositories.
...
- [ ] **Measured outcomes:** reduced manual work, improved load time, launch
  ...
  issues.
- [ ] **Decision examples:** one or two examples of selecting a stack or
...
- [ ] **Coordination tools:** GitHub Projects, Jira, Trello, Notion, ClickUp,
  Slack, or other tools actually used.

### Evidence to Gather Before Updating the Resume
...
Emphasize React, React Native, TypeScript, mobile development, API
integration, authentication, app deployment, performance, and UI work.

### Node.js Developer

Emphasize Node.js, Express, REST APIs, authentication, databases, AWS,
backend architecture, and integrations.

### Technical Lead / Lead Developer

Use this version only when experience supports it. Emphasize architecture
decisions, technical ownership, code reviews, mentoring, task delegation,
